...
propertyList.forEach(function(property, index = 0){
    container.innerHTML += 
`<div class="p-4 md:w-1/3">
    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-xl overflow-hidden">
      ...
      <div class="p-6">
        ...
        <div class="flex items-center flex-wrap">
          <a id="ingredient-button-${index}" class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0 cursor-pointer">En savoir plus
